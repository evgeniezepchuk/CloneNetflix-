...
class PopularViewCell: UITableViewCell {
    ...
    static let identifire = "PopularViewCell"
    var movies: [Movie] = []
    ...
    let collectionView = {
        ...
        cv.register(UICollectionViewCell.self, forCellWithReuseIdentifier: "PopularViewCell")
        return cv
    }()
...
extension PopularViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        APICaller.shared.getTrendingPopular(complition: { [weak self] result in
            switch result {
            case .success(let title):
                self?.movies = title
                print("str id = \(self?.movies[indexPath.row].poster_path ?? "")")
